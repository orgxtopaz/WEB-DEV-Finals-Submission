...
if (!isset($_SESSION['adminusername'])) { //if the variable adminusername is being set,
  header('location:adminlogin.php'); //then it will set the location to adminlogin
} else {
  //  
}
...
<head>
  ...
  <title>Disable Admin|Inventory Management System</title>
  ...
  <div class="page-wrapper chiller-theme toggled">
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  ...
                  <li>
                    <a href="disableuser.php">Disabled User's</a>
                  </li>
                </ul>
              </div>
            </li>
    ...
    <main class="page-content">
      <div class="container-fluid">
        ...
        <table id="myTable">
          <h4>Search:&nbsp; <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for admin.."> </h4>
          ...
          ?>
                ...
                <tr>
                  ...
                  <td style="text-align:center">
                    <a href="connection.php?enableadmin=<?php echo $row['adminId']; ?>&username=<?php echo $row['username']; ?>&password=<?php echo $row['password']; ?>" class="btn btn-danger">Enable Admin</a>
                  </td>
