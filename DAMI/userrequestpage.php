...
<!-- navigation bar -->
  <header class="header" id="header">
    ...
    <!-- char2 profile in the right part of the navigation bar -->
    ...
    <table id="myTable">
     <h3>Search: &nbsp;<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for brand.."></h4> 
      ...
      if ($conn->connect_error) {
        ...
        $sql = "SELECT * FROM `request` WHERE username ='$usernameId'";
      ...
      ?>
            ...
            <tr>
              ...
              <td>
                ...
                <i class="fa fa-recycle  fa-spin fa-3x" aria-hidden="true"></i> On Process
              </td>
            </tr>
