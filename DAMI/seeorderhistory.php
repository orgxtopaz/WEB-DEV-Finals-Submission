<?php
session_start(); //set sission to adminusername
if (!isset($_SESSION['adminusername'])) { //if the variable adminusername is being set,
  header('location:adminlogin.php'); //then is will set the location to adminlogin.php
} else {
  //
}
          ...
          <ul>
            ...
            <li class="sidebar-dropdown">
              <a>
                ...
                $count = 0;
                //query that selects all data from procducts table
       ...
       <h4>Search: &nbsp; <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for brand.."></h4> 
          ...
          ?>
                ...
                <tr>
                  ...
                  <td>
                    <img alt="" width="40px" src="<?php echo $row['status']; ?>">
                  </td>
