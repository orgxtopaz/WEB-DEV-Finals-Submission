<?php
session_start(); //setting session to adminusername
if (!isset($_SESSION['adminusername'])) { //if the varialve adminusername is being set,
        ...
        <table id="myTable">
          ...
          ?>
                ...
                <tr>
                  ...
                  <td style="text-align:center">
                    <a href="connection.php?disableadmin=<?php echo $row['ID']; ?>&username=<?php echo $row['username']; ?>&password=<?php echo $row['password']; ?>" class="btn btn-danger">Disable Admin</a>
