...
<head>
  ...
  <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,300,700' rel='stylesheet' type='text/css'>
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  <title>Products|InventoryMS</title>
                ...
                <div class="modal-body">
                  <form action="connection.php" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" placeholder="Photo" name="photo" required class="form-control" id="inputName" value="">


                      <div class="mb-3">
                        <label for="InputPhoto" class="form-label">productName</label>
                        <input type="text" name="name" class="form-control" required id="inputPhoto" placeholder="Name" value="">
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" placeholder="Brand" name="brand" class="form-control" id="inputType" value="" required>
                      </div>

                      <div class="mb-3">
                        <label for="inputType" class="form-label">productDescription</label>
                        <input type="text" placeholder="Description" name="description" class="form-control" id="inputType" value="" required>
                      </div>


                      <div class="mb-3">
                        <label for="inputType" class="form-label">productPrice</label>
                        <input type="text" placeholder="Price" name="price" class="form-control" id="inputType" value="" required>
                      </div>

                      <div class="mb-3">
                        <label for="inputType" class="form-label">stocks</label>
                        <input type="text" placeholder="Stocks" name="stocks" class="form-control" id="inputType" value="" required>
                      </div>
          ...
          <h4>Search:&nbsp; <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for brand.."></h4>
            ...
            <thead class="table-dark">
              ...
              <tr>
                ...
                <th scope="col" style="text-align:center">Prize</th>
                <th scope="col" style="text-align:center">Stocks</th>
                <th scope="col" style="text-align:center">Action</th>
                <th scope="col" style="text-align:center">Do</th>
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                      <a href="connection.php?editproduct=<?php echo $row['productId']; ?>" class="btn btn-warning">Update</a>

                    </td>

                    <td style="text-align:center">
                      <a href="connection.php?archivedproduct=<?php echo $row['productId']; ?>&archivedphoto=<?php echo $row['productPhoto']; ?>&archivedname=<?php echo $row['productName']; ?>&archivedbrand=<?php echo $row['productBrand']; ?>&archivedDescription=<?php echo $row['productDescription']; ?>&archivedPrice=<?php echo $row['productPrice']; ?>&archivedstocks=<?php echo $row['stocks']; ?>" class="btn btn-success">Archive</a>
