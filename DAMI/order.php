...
<head>
  ...
  <title>Ordered Products|Inventory Management System</title>
</head>

<body id="body-pd">
  <!-- header side navigation bar icon -->
  ...
  <div class="container-fluid">
    ...
    <table id="myTable">
      ...
      if ($conn->connect_error) {
        ...
        $sql = "SELECT * FROM `order` WHERE username ='$usernameId'";
      ...
      ?>
            ...
            <tr>
              ...
              <td>
                <i class="fa fa-recycle  fa-spin fa-3x" aria-hidden="true"></i> <?php echo $row['status']; ?>
