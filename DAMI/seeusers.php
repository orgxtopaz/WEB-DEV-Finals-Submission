...
<head>
  ...
  <title>Add|Users|InventoryMS</title>
</head>
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  ...
                  <li>
                    <a href="seeusersblock.php">Block User's </a>
                  </li>
                </ul>
              </div>
            </li>
                ...
                <div class="modal-body">
                  <form action="connection.php" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" placeholder="Username" name="username" required class="form-control" id="inputName" value="">


                      <div class="mb-3">
                        <label for="InputPhoto" class="form-label">email</label>
                        <input type="email" name="email" class="form-control" required id="inputPhoto" placeholder="email" value="">
                      </div>



                      <div class="mb-3">
                        <label for="inputType" class="form-label">password</label>
                        <input type="password" placeholder="Password" name="password" class="form-control" id="inputType" value="" required>
                      </div>
          ...
          <table id="myTable">
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                      <a href="connection.php?disableuser=<?php echo $row['ID']; ?>&username=<?php echo $row['username']; ?>&password=<?php echo $row['password']; ?>&email=<?php echo $row['email']; ?>" class="btn btn-danger">Disable User</a>

                    </td>

                    <td style="text-align:center">
                      <a href="connection.php?addasadmin=<?php echo $row['ID']; ?>&username=<?php echo $row['username']; ?>&password=<?php echo $row['password']; ?>" class="btn btn-success">as admin</a>
